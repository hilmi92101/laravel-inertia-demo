    ...
    <DashboardLayout>
        ...
        <div class="w-full mt-4">
            <div class="p-8 bg-white rounded-2xl shadow-md">
                <h2 class="text-2xl font-bold text-gray-800">Toast</h2>

                <div class="my-5">
                    <button type="button" class="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 mr-2 mb-2 dark:bg-blue-600 dark:hover:bg-blue-700 focus:outline-none dark:focus:ring-blue-800">Show Toast</button>
                </div>
